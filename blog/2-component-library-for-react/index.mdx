...
Auto depends on labels that are added to PR to make a decision to release. So, we need to create labels on our repo.
...
- At this point, you should find a version in npm that is similar to `0.1.0--canary.457943b.0 -D`
